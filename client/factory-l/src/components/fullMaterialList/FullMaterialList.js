...
import classes from "./FullMaterialList.module.css";
    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.sectionsDiv}>
        ...
        <ListItem
          ...
          image="https://i.ibb.co/y6gCg7c/nylon.webp"
          width="400"
          height="400"
          ...
          />
        <ListItem
          image="https://i.ibb.co/j3zrKXc/resin.webp"
          width="400"
          height="400"
        ...
        <ListItem
          image="https://i.ibb.co/ByjQ9PX/silk-pla.webp"
          width="400"
          height="400"
...
export default FullMaterialList;
